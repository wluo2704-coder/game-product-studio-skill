...
ROLES = {
    ...
    "prototype_architect": ("Plan small core-loop spikes and the evidence needed to choose one.", "02_design/prototype/"),
...
def main() -> int:
    ...
    write(target / "START_HERE.md", "# Startup Order\n\n1. Lead\n2. Selected prototype, design, art, technical, or product-Agent contributor\n3. Lead integration\n4. QA\n5. Reflection\n\n" + note + "\n")
